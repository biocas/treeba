...
// Add checkbox and label elements for the layer.
                ...
                filterInput.id = mapLayers.id;
                filterInput.checked = true;
                filterGroup.appendChild(filterInput);

                const filterLabel = document.createElement('label');
                filterLabel.setAttribute('for', mapLayers.id);
                filterLabel.textContent = mapLayers.id;
...
const lister = createLayeredNameLister(map, {
  layerIds: [
      ...
      'Centrais Solares Existentes e em licensiamento' 
    ],
  mode: 'rendered',
  container: '#listaCentrais .contentContainer',
  labels: {
    'Centrais Solares Existentes e em licensiamento': 'Centrais Solares Existentes ou em processo de licensiamento',
